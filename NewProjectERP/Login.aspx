<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="NewProjectERP.Login" %>
  ...
  <div class="content">
    ...
    <div class="modal-content">
        <div class="modal-header">
          <h1 class="text-center">Welcome to Maheen ERP</h1>
        </div>
         <div class="modal-body">
    <form class="form-vertical login-form"  runat="server">
              <center><h4 class="form-title">Please Login</h4></center>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <div class="input-icon left">
            <i class="icon-user"></i>
               <asp:TextBox id="UserName" runat="server" type="text" placeholder="Username" class="form-control input-lg" />
          </div>
            <div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <div class="input-icon left">
            <i class="icon-lock"></i>
              <asp:TextBox id="Pass"   textmode="Password" placeholder="Password" runat="server" class="form-control input-lg"/>
          </div>
          <div class="col-sm-2">
    ...
    <center> <asp:Label ID="MyMessage" ForeColor="Red" CssClass ="NormalRed" runat="server"></asp:Label></center>
        <asp:Button ID="LoginBtn" class="btn btn-block btn-lg btn-primary" runat="server" OnClick="LoginBtn_Click" 
                        Text="Login"></asp:Button>    <asp:linkbutton ID="linkCategory" OnClick="linkCategory_Click"  Text="Register"  Runat="server" />
          <asp:linkbutton ID="Linkbutton1"   Text="Forget Password"  Runat="server" />
      </div>
