...
namespace MLTL_ERP
{
    public partial class NPD_Offset_Spec : System.Web.UI.Page
    {
        ...
        public void Commom_GridLoad(string SampleID)
        {
            ...
            {
                using (MySqlCommand cmd = new MySqlCommand("lOAD_grid_npd_offset_spec_proc", con))
                {
        ...
        private void ProgramList(int BrandID)
        {
            ...
            using (MySqlConnection con = new MySqlConnection(constr))
            {
                ...
                //using (MySqlCommand cmd = new MySqlCommand("Load_Brand_WiseSubBrand_in_DownBox_proc", con))
                //{
                //    cmd.CommandType = CommandType.StoredProcedure;
            ...
            ddlProgram.Items.Insert(0, new ListItem("--Select Brand--", "0"));
        ...
        public void ProductSubCategory()
        {
            ...
            using (MySqlConnection con = new MySqlConnection(constr))
            {
                using (MySqlCommand cmd = new MySqlCommand("Load_Offset_ProductSubCategory"))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Connection = con;
                    con.Open();
        ...
        public void Client()
        {
            ...
            ddClient.Items.Insert(0, new ListItem("--Select Customer--", "0"));
        }
        public void Company()
        {
            string constr = ConfigurationManager.ConnectionStrings["MaheenERPConnection2"].ConnectionString;
        ...
        public void Executive()
        {
            ...
            ddPDExecutive.Items.Insert(0, new ListItem("--Select Sales Person--", "0"));
        }
        public void UoM()
        {
            string constr = ConfigurationManager.ConnectionStrings["MaheenERPConnection2"].ConnectionString;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable DuplicateDate2 = DB.DuplicateSampleNameoffset((txtSampleName.Text.Trim()));
                if (DuplicateDate2.Rows[0][0].ToString() == "1")
                {
                ...
                DataTable DuplicateDate = DB.DuplicateDateTableOffset(Int32.Parse(ddBrand.SelectedValue), Int32.Parse(ddlProgram.SelectedValue), Decimal.Parse(txtLenghtmm.Text.Trim()), Decimal.Parse(txtwidthmm.Text.Trim()), Decimal.Parse(txtPaperGSM.Text.Trim()), Decimal.Parse(txtNoofUPS.Text.Trim()), Int32.Parse(txtQuotedPrice.Text.Trim()), txtImagepath.Text.Trim());
                ...
                using (MySql.Data.MySqlClient.MySqlConnection conn = new MySql.Data.MySqlClient.MySqlConnection(constr))
                {
                    ...
                    cmd.Connection = conn;
                    cmd.CommandText = "CALL InsertUpdateOffset_spec(@Offser_ID,@SampleID,@SampleName, @BrandID, @ProgramID, @ProductCategoryID,@ProductSubCategoryID, @ClientID, @CompanyID, @NPDExecutive, @Unit, @Length, @Width,@PaperGsm,@NoOfUps, @QuotedPrice, @ArtworkLocation_FileName, @Imagepath, @Cancel, @CreatedBy ,@CreationDate, @Status , @TotalNoOfColor , @ModifyBy, @ModifyDate, @CommandID);";

                    cmd.Parameters.Add("@Offser_ID", MySql.Data.MySqlClient.MySqlDbType.Int32).Value = 0;
                    cmd.Parameters.Add("@SampleID", MySql.Data.MySqlClient.MySqlDbType.Int32).Value = 32;
                    ...
                    cmd.Parameters.Add("@ProductCategoryID", MySql.Data.MySqlClient.MySqlDbType.Int32).Value = 5;
                    ...
                    cmd.Parameters.Add("@PaperGsm", MySql.Data.MySqlClient.MySqlDbType.Decimal).Value = txtPaperGSM.Text;
                    cmd.Parameters.Add("@NoOfUps", MySql.Data.MySqlClient.MySqlDbType.Decimal).Value = txtNoofUPS.Text;
                    ...
                    cmd.Parameters.Add("@ModifyBy", MySql.Data.MySqlClient.MySqlDbType.Int32).Value = 68;
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (MySql.Data.MySqlClient.MySqlConnection conn = new MySql.Data.MySqlClient.MySqlConnection(constr))
                {
                    ...
                    cmd.Parameters.Add("@Offser_ID", MySql.Data.MySqlClient.MySqlDbType.Int32).Value = Label1.Text;
        ...
        {
            Response.Redirect("/NPD/NPD_Offset_Spec.aspx?");
        }
        ...
        private void showSpecdata()
        {
            ...
            txtPaperGSM.Text = gvDepartment.SelectedRow.Cells[21].Text.Replace("amp;", "").Replace("&nbsp;", "");
            txtNoofUPS.Text = gvDepartment.SelectedRow.Cells[22].Text.Replace("amp;", "").Replace("&nbsp;", "");
            txtQuotedPrice.Text = gvDepartment.SelectedRow.Cells[23].Text.Replace("amp;", "").Replace("&nbsp;", "");
            txtArtworkLocation.Text = gvDepartment.SelectedRow.Cells[24].Text.Replace("amp;", "").Replace("&nbsp;", "");
            txtImagepath.Text = gvDepartment.SelectedRow.Cells[25].Text.Replace("amp;", "").Replace("&nbsp;", "");
            ddlCancel.Text = gvDepartment.SelectedRow.Cells[26].Text.Replace("amp;", "").Replace("&nbsp;", "");
            txtTotalColor.Text = gvDepartment.SelectedRow.Cells[27].Text.Replace("amp;", "").Replace("&nbsp;", "");
        }
        ...
        {
            Response.Redirect("../NPD/npd_Offset_techonical.aspx?SampleID=" + Label2.Text);
        }

        protected void LinkbuttonMaterials_Click(object sender, EventArgs e)
        {
            Response.Redirect("../NPD/Npd_Offset_Materials.aspx?SampleID=" + Label2.Text);
        }
