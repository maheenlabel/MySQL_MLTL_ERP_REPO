...
namespace MLTL_ERP
{
    public partial class NPD_Woven_Spec : System.Web.UI.Page
    {
        ...
        public void Commom_GridLoad(string SampleID)
        {
            ...
            using (MySqlConnection con = new MySqlConnection(constr))
            {
                ...
                using (MySqlCommand cmd = new MySqlCommand("Load_Grid_npd_woven_spec_proc", con))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void ProductSubCategory()
        {
            ...
            ddSubCategory.Items.Insert(0, new ListItem("--Select Brand--", "0"));
        }
        ...
        public void Client()
        {
            ...
            ddClient.Items.Insert(0, new ListItem("--Select Brand--", "0"));
        }
        public void Company()
        {
            string constr = ConfigurationManager.ConnectionStrings["MaheenERPConnection2"].ConnectionString;
            ...
            ddlCompany.Items.Insert(0, new ListItem("--Select Brand--", "0"));
        }
        ...
        public void Executive()
        {
            ...
            ddPDExecutive.Items.Insert(0, new ListItem("--Select Brand--", "0"));
        }
        public void UoM()
        {
            string constr = ConfigurationManager.ConnectionStrings["MaheenERPConnection2"].ConnectionString;
            ...
            ddlUnit.Items.Insert(0, new ListItem("--Select Brand--", "0"));
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable DuplicateDate = DB.DuplicateDateTableWoven(Int32.Parse(ddBrand.SelectedValue), Int32.Parse(ddlProgram.SelectedValue), Decimal.Parse(txtLenghtmm.Text.Trim()), Decimal.Parse(txtwidthmm.Text.Trim()), Int32.Parse(txtQuotedPrice.Text.Trim()), txtImagepath.Text.Trim());
                ...
                using (MySql.Data.MySqlClient.MySqlConnection conn = new MySql.Data.MySqlClient.MySqlConnection(constr))
                {
                    ...
                    cmd.Parameters.Add("@ProductCategoryID", MySql.Data.MySqlClient.MySqlDbType.Int32).Value = 1;
                ...
                using (MySql.Data.MySqlClient.MySqlConnection conn = new MySql.Data.MySqlClient.MySqlConnection(constr))
                {
                    MySql.Data.MySqlClient.MySqlCommand cmd = new MySql.Data.MySqlClient.MySqlCommand();
                    cmd.Connection = conn;
                    cmd.CommandText = "CALL InsertUpdateNpd_Woven_Spec(@woven_ID,@SampleID,@SampleName, @BrandID, @ProgramID, @ProductCategoryID,@ProductSubCategoryID, @ClientID, @CompanyID, @NPDExecutive, @Unit, @Length, @Width, @QuotedPrice, @ArtworkLocation_FileName, @Imagepath, @Cancel, @CreatedBy ,@CreationDate, @Status , @TotalNoOfColor , @ModifyBy, @ModifyDate, @CommandID);";

                    cmd.Parameters.Add("@woven_ID", MySql.Data.MySqlClient.MySqlDbType.Int32).Value = 0;
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (MySql.Data.MySqlClient.MySqlConnection conn = new MySql.Data.MySqlClient.MySqlConnection(constr))
                {
                    ...
                    cmd.Parameters.Add("@woven_ID", MySql.Data.MySqlClient.MySqlDbType.Int32).Value = Label1.Text;
        ...
        {
            Response.Redirect("/NPD/NPD_Woven_Spec.aspx?");
        }
        ...
        {
            Response.Redirect("../NPD/npd_Woven_techonical.aspx?SampleID=" + Label2.Text);
        }

        protected void LinkbuttonMaterials_Click(object sender, EventArgs e)
        {
            Response.Redirect("../NPD/Npd_Woven_Materials.aspx?SampleID=" + Label2.Text);
        }
    }
}